...
from .views import teacher_login, teacher_dashboard, claim_booking, tutor_list, teacher_calendar_events, public_teacher_profile
...
urlpatterns = [
    ...
    path('teachers/<slug:slug>/', public_teacher_profile, name='teacher_profile'),
]
